...
export const GUIDE: readonly Section[] = [
  ...
  S("hafiza", "Hafıza", "Beynin gördüğünü ve yaşadığını hatırlayan parçası. Basitten karmaşığa kuruluyor (TASARIM-008); ilk modüller konum ve yemek hafızası.", [
    ...
    },
    {
      ...
      long: "Beden dönerken hızının bir kısmı eski yönde kalır ve sürtünmeyle yavaş yavaş söner; buzda dönen bir araba gibi, çok daha hafif. Hareket duyusu hızın yalnız ileri bileşenini bildirir, yana kaymayı bildirmez. İlk tasarımdaki formül bu yüzden eksikti: K1n öğrenenlerinde 3000 tik sonunda 2,6 m sapıyordu. Yana kayma, bedenin kendi sürtünmesinden hesaplanabiliyor. Duvara değmeyen bir bedende konum artık kayan nokta hassasiyetinde doğru: 3000 tikte 0,000000000001 m hata.\n\nDuvara değen beden de duvar boyunca kayar. Duvarı en az iki ışınıyla görüyorsa, duvarın yönünü bulur ve bu kaymayı da hesaplar (A1b): temastan sonra hız duvara paralel olmak zorundadır.",
    },
    {
      id: "konumhatasi",
      term: "Konum hatası",
      short: "Hafızanın bedeni sandığı yer ile gerçek yeri arasındaki uzaklık (metre).",
      long: "Simülasyonda gerçek konumu bildiğimiz için hafızayı tam olarak notlayabiliyoruz; gerçek bir robotta bu mümkün değil. Beden bu sayıyı görmez, yalnız biz görürüz.\n\nHatanın tamamı duvar temasından geliyor. Duvar, hızın duvara doğru bölümünü siler; beden hangi duvara hangi açıyla değdiğini hareket duyusundan bilemez. Temas anında duvarı ışınlarıyla görürse yönünü bulur ve kaymayı hesaplar (A1b). Duvar arkada kalırsa (beden geri geri çarparsa) göremez; kalan hatanın neredeyse tamamı bu temaslardan geliyor.",
      read: "0 = tam doğru. Oda 10 m; 0,5 m, iki harita hücresi kadar.",
      target: "3000 tikte ortalama 0,5 m'den az. Ölçülen (A1b): K1n öğrenenlerinde 0,10 m; taze deneklerde (seed 11–20, 20 öğrenen) 0,12 m. Çok hareket eden bedenlerde (arayıcı) 0,8 m; hedefin üstünde. Kalan hatayı arkada kalan duvarlar yapıyor; hatırlanan duvarlar (harita) düzeltebilir.",
    },
    {
      id: "konumguveni",
      term: "Konum güveni",
      ...
      target: "Gerçek hata / σ oranı 0,5 ile 2 arasında (dürüst güven). Ölçülen 0,60 (A1b). Taze K1n deneklerinde 0,29, hedefin altında: güven fazla temkinli. Bu denekler temasların çoğunda duvarı buluyor ve orada hata büyümüyor, σ ise her temasta büyüyor.",
    },
    {
      id: "yemekhafizasi",
