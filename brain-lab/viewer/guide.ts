...
export const GUIDE: readonly Section[] = [
  ...
  S("hafiza", "Hafıza", "Beynin gördüğünü ve yaşadığını hatırlayan parçası. Basitten karmaşığa kuruluyor (TASARIM-007); ilk modül konum.", [
    ...
    },
    {
      ...
      target: "3000 tikte ortalama 0,5 m'den az. Ölçülen (A1b): K1n öğrenenlerinde 0,10 m. Çok hareket eden bedenlerde (arayıcı) 0,8 m; hedefin üstünde. Kalan hatayı arkada kalan duvarlar yapıyor; hatırlanan duvarlar (harita) düzeltebilir.",
    },
    {
      id: "konumguveni",
      term: "Konum güveni",
